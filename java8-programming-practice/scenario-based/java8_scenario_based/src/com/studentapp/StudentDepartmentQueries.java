...
public class StudentDepartmentQueries {
	public static void main(String[] args) {
		List<Student> students = Arrays.asList(
				new Student("Amit Kumar", 1, "Amit", 22, "Male", "Mumbai", 45, "Computer Engineering",
						Arrays.asList("9876543210", "9123456780")),
				new Student("Sneha Sharma", 2, "Sneha", 24, "Female", "Karnataka", 30, "Mechanical Engineering",
						Arrays.asList("9876543211")),
				new Student("Rahul Verma", 3, "Rahul", 26, "Male", "Karnataka", 60, "Electronics Engineering",
				...
				new Student("Kavya Menon", 10, "Kavya", 24, "Female", "Karnataka", 35, "Electronics Engineering",
						Arrays.asList("9876543219", "9123456784")));

		System.out.println("1. Students department-wise with names only:");
		...
		students.stream().filter(s -> s.getDepartment().equals("Computer Engineering"))
		...
		long count = students.stream()
				.filter(s -> s.getDepartment().equals("Electronics Engineering") && s.getCity().equals("Karnataka"))
				.count();
