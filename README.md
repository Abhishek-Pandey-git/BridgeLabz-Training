...
- Set up GitHub repository and verified remote.
...
🔗 **Code Link:**  
👉 https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/programming-elements
...
🔗 **Code Link:**  
👉 https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/control-flows
...
- Traversal and common operations.
- Array-based problem solving.

🔗 **Code Link:**  
👉 https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/arrays
...
- Method declaration, calling, and parameters.
...
- Core methods and character processing.
- String practice problems.

🔗 **Code Link:**  
👉 https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/strings
...
- Common Java built-ins, including `Math`, `Arrays`, and `java.time`.
- Utility programs (e.g., Temperature Converter).

🔗 **Code Link:**  
👉 https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/extras
...
## (12-Jan-2026): Advanced Scenario-Based DSA Problems
...
4. **TrafficManager** - Roundabout Vehicle Flow (Circular LinkedList + Queue)
 ...
 #### Advanced OOP Scenario Projects
...
**Exception Handling Programs:** 👉 [View Code](https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/java-generics-practice/java-generics-practice/gcr-codebase/genericsPractice/src/com/exceptionhandling)
...
**Regular Expression Programs:** 👉 [View Code](https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/java-generics-practice/java-generics-practice/gcr-codebase/genericsPractice/src/com/regex)
...
- Practical exercise: Reading from and writing to a CSV file
  ...
  **LINK:** https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/java-ioprograming-practice/java-ioprogramming-practice/gcr-codebase/ioprogramming/src/com/csvhandling
...
<br>
**LINK - Transaction Management** : [Banking System](https://github.com/Abhishek-Pandey-git/BridgeLabz-Training/tree/mysql-jdbc-practice/mysql-jdbc-practice/gcr-codebase/mysql_jdbc_practice/src/jdbc_practice/transaction_management)
